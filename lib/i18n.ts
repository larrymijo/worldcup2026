...
const en: Dict = {
  ...
  "ec.subtitle":
    "Follow every Ecuador fixture — kick-off times shown in your own timezone{tz}. Counting down to the next match below.",
...
const es: Dict = {
  ...
  "ec.subtitle":
    "Sigue todos los partidos de Ecuador — horarios mostrados en tu zona horaria{tz}. Cuenta atrás para el próximo partido abajo.",
